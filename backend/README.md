...
## Project Structure
    ...
    ├── tranquil_library_up_39937  # Django project configurations
...
1. Clone this repo and `cd tranquil_library_up_39937`
...
2. Clone this repo and `cd tranquil_library_up_39937`
