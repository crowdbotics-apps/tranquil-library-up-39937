"""
Django settings for tranquil_library_up_39937 project.
...
ROOT_URLCONF = 'tranquil_library_up_39937.urls'
...
WSGI_APPLICATION = 'tranquil_library_up_39937.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tranquil_library_up_39937 API",
    "DESCRIPTION": "API documentation for tranquil_library_up_39937 App",
    "VERSION": "v1",
}
